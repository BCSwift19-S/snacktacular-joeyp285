...
extension SpotDetailViewController: CLLocationManagerDelegate {
    ...
    extension SpotDetailViewController: UINavigationController, UIImagePickerControllerDelegate {
        
       
        func imagePickerController(_ picker: UIImagePickerController,
                                   didFinishPickingMediaWithInfo info: [UIImageletPickerController.InfoKey : Any]) {
            
            let photo = Photo()
            photo.image = info[UINavigationController.InfoKey.originalImage] as! UIImage
